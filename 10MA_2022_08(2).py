def trade_with_ma(stock_no='0050.TW',start="2018-01-01",end= "2022-8-7",win=0.09,loss=0.03,ma=10):
    ...
    return f"\n原始資金為100\n單純用{ma}日均線進出場,最後資金為{money1:.2f},總交易次數為{len(ma_return)},勝率為{money1_win*100:.2f} \n用{ma}日均線進場,出場用盈虧比,最後資金為{money2:.2f},總交易次數為{len(win_loss_ratio)},勝率為{money2_win*100:.2f}%"
#######################################################################################
import pandas as pd
